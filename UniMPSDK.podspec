...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/shunqiziran199202/UniMPSDK'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'shunqiziran199202' => '2405632981@qq.com' }
  s.source           = { :git => 'https://github.com/shunqiziran199202/UniMPSDK.git', :tag => s.version.to_s }
  # s.social_media_url = 'https://twitter.com/<TWITTER_USERNAME>'

  s.ios.deployment_target = '9.0'

  s.source_files = 'UniMPSDK/Classes/**/*'
